...
from project_themoth.items import EventsItem
...
class EventsSpider(scrapy.Spider):
    name = "events"
    allowed_domains = ["themoth.org/"]
    start_urls = ["https://themoth.org/events/results?eventLocations=65&typesOfEvents=&eventDate","https://themoth.org/events/results?eventLocations=6486&typesOfEvents=&eventDate"]
